...
export default {
  ...
  methods: {
    ...
    async open() {
      //生成二维码
      // let url = await QRCode.toDataURL(this.payInfo.data.codeUrl);
      // let url = '../../../public/images/pay.png';
      // console.log(url);
      this.$alert("这是一个付款码", "请你微信支付", {
        //是否显示为html片段
      ...
      // 需要知道支付是否成功
      // 如果支付成功，路由跳转 ， 如果失败，提示失败信息
      // 如果没有定时器，则开启定时器，每隔一秒获取支付结果
